...
abstract class AppLocalizations {
  ...
  /// No description provided for @settingsPersonalizeFeed.
  ///
  /// In en, this message translates to:
  /// **'Personalize Your Feed'**
  String get settingsPersonalizeFeed;

  /// No description provided for @settingsHdImage.
  ///
  /// In en, this message translates to:
  /// **'HD Image'**
  String get settingsHdImage;
  ...
  /// No description provided for @settingsNightModeDesc.
  ///
  /// In en, this message translates to:
  /// **'For better readability at night'**
  ...
  /// No description provided for @onboardingRegionNext.
  ///
  /// In en, this message translates to:
  /// **'Next'**
  String get onboardingRegionNext;

  /// No description provided for @selectedLanguageTitle.
  ///
  /// In en, this message translates to:
  /// **'News on the go.'**
  String get selectedLanguageTitle;

  /// No description provided for @selectedLanguageDesc.
  ///
  /// In en, this message translates to:
  /// **'We summarize and curate news\nfocused on your interests so you can\nread more quickly.'**
  String get selectedLanguageDesc;

  /// No description provided for @selectedLanguageNext.
  ///
  /// In en, this message translates to:
  /// **'Next'**
  String get selectedLanguageNext;
}
